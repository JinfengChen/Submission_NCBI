...
def maskregion(prefix,id_mask, agp, contig):
...
def main():
    ...
    agp = 'A123v1.0_revision/A123v1.0.agp'
    #contig = fasta_seq('HEG4v1.0/HEG4v1.0.contigs.fa')
    prefix = 'A123v1.0_revision/A123v1.0'
    #maskregion(prefix, id_mask, agp, contig)
    update_agp(prefix, agp)
